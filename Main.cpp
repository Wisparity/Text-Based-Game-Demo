...
int main() {
	...
	bool chest1 = false;
	bool HasWon = false;
	while (input != "q"&& HasWon == false ) {//game loop
		...
		case 1:
			...
			break;
		case 2:
			cout << "you're in room 2, you can can go (e)ast, (w)est, (s)outh" << endl;
			cin >> input;
		...
		case 5:
			...
			break;
		case 6:
			cout << "you're in room , you can can go (N)orth,  (s)outh" << endl;
			cin >> input;
...
void shop() {
	...
	while (input != 0) {
		...
		cout << "We sell our magical wears to suit your tears! Here's what I got:" << endl;
